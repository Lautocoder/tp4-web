...
import ht.lafleur.tp4weblafleur.llm.LlmClientPourClaude;
...
public class Bb implements Serializable {
     ...
     */
    @Inject
    private LlmClientPourClaude llmClient;
    ...
    public String envoyer() {
        ...
        // 1. On prépare l'affichage de la question immédiatement dans l'historique
        this.conversation.append("===== User:\n").append(question).append("\n===== Serveur:\n");
        // On envoie un signal au socket pour dire qu'un nouveau message commence
        webSocketPourChat.send("[NEW_MSG] ===== User:\n" + question + "\n===== Serveur:\n");

        this.reponse = ""; // On vide la réponse précédente

        TokenStream tokenStream = llmClient.envoyerRequete(this.question);
        tokenStream
                ...
                .onCompleteResponse(response -> {
                    ...
                    this.reponse = aiMessage.text();
                    this.conversation.append(this.reponse).append("\n");
                    llmClient.addReponse(aiMessage);
    ...
    public List<SelectItem> getRolesSysteme() {
        if (this.listeRolesSysteme == null) {
            ...
            role = """
                    You are a RAG assistant. Answer questions based on the provided documents.
                    """;
            this.listeRolesSysteme.add(new SelectItem(role, "Assistant RAG"));
        }
